        ...
        <v-layout align-center justify-center>
          <v-flex xs12 sm8 md4>
            <v-card class="elevation-12">
              ...
              <v-card-text>
                <v-form>
                  <v-text-field prepend-icon="mdi-account" name="login" label="Login" type="text" v-model="account"></v-text-field>
    ...
    methods:{
        login(){
            ...
            .request({
                ...
                then(respose => {
                    console.log(respose)
                    if (respose.data.msg == "OK") {
                        console.log(this);
                        this.$router.push("/navlist");
                        // this.$router.push({name:"NavList"})
                    }
                });
        },
    },
